...
sed "s/NAT_ID=/NAT_ID=${NAT1Instance}/g" /root/nat_monitor.sh > /root/nat_monitor.tmp
sed "s/NAT_RT_ID=/NAT_RT_ID=${PrivateRouteTable1}/g" /root/nat_monitor.tmp > /root/nat_monitor.sh
sed "s/My_RT_ID=/My_RT_ID=${PrivateRouteTable2}/g" /root/nat_monitor.sh > /root/nat_monitor.tmp
